...
def translate(sentence: str):
    ...
    model_filename = config.latest_weights_file_path()
    ...
    if type(sentence) == int or sentence.isdigit():
        id = int(sentence)
        ds = load_dataset(f"{config.datasource}", name=config.datasource_name, split='all', data_files=config.data_files, token = config.hf_token)
